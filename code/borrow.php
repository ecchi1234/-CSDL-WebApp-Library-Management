  ...
  <script type="text/javascript">
    $(document).ready(function() {
      ...
      $('.borrow').click(function() {
        borrowmodalhtml = $("#borrowModal").html();
        var bookCode = $(this).data('id');
        // AJAX request
        $.ajax({
          url: 'borrow-form-display.php',
          type: 'post',
          data: {
            bookCode: bookCode
          },
          success: function(response) {
            ...
            $('#borrowModal .modal-body').html(response);
                ...
                ?>
                    <div class="col-sm-auto mt-4">
                      <div class="card" style="width: 20rem;">
                        <img class="card-img-top" src="<?php echo $post['bookImage']; ?>" alt="Card image cap" onerror="this.onerror=null;this.src='./img/book.png';">
