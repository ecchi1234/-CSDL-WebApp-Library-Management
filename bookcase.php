          ...
          <div class="card shadow mb-4 ">
            ...
            <div class="card-body card-body-book">
              <div class="row row-book">
                ...
                $calc = $perpage * $page;
                $start = $calc - $perpage;
                $sql = "SELECT b.bookCode, b.bookName, b.bookImage, a.authorName, c.categoryName, p.publisherName, b.publishYear, b.quantity, SUM(ac.quantity) as borrowed, ac.actionCode FROM books b
                     ...
                     LEFT JOIN actions ac ON ac.bookCode = b.bookCode
                     WHERE b.bookCode IN (SELECT bookCode FROM actions WHERE cardNumber=" . $_SESSION['id'] . " AND dateBack IS NULL) AND ac.dateBack IS NULL
                     GROUP BY b.bookCode
                     LIMIT " . $start . ", " . $perpage;
                    ...
                    <div class="col-sm-auto mt-4">
                      <div class="card" style="width: 20rem;">
                        <div class="row" style="justify-content: flex-end;">
                          <div class="col-4">
                            <div class="bg-success text-center" style="color: #fff;"><?php echo $post['borrowed']; ?></div>
                          </div>
                        </div>
                        ...
                        <div class="row" style="justify-content: center;">
                          <form action="returnbook.php" method="post">
                            <button type="submit" class="btn btn-danger btn-danger-book text-center" name="return" value="<?php echo $post['actionCode']; ?>">Trả sách</button>
                          </form>
                        </div>
                      </div>
                    </div>
                <?php }
                  ...
                  echo "<h2>Bạn chưa mượn quyển sách nào!</h2>";
                } ?>
                <!---->
              </div>
            </div>
